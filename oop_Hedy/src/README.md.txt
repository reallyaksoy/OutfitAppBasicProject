# HEDY - Akıllı Gardırop ve Yaşam Asistanı Arka Uç Motoru
...
Aşağıdaki UML (Unified Modeling Language) diyagramı, sistem sınıfları arasındaki ilişkileri, bağımlılıkları ve hiyerarşiyi göstermektedir.

![UML Diyagramı](hedy_uml.png)
*(Lütfen kök dizinde hedy_uml.png dosyasının bulunduğundan emin olun)*
